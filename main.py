...
class Processor():
    ...
    def start(self):
        tokenizer = MBartTokenizerFast.from_pretrained("/home/tian/CM2f/mbart-large-cc25", use_auth_token=False, local_files_only=True)
        tokenizer.model_max_length = 256
        mbartencode = MBartModel.from_pretrained("/home/tian/CM2f/mbart-large-cc25", use_auth_token=False, local_files_only=True)
        for param in mbartencode.parameters():
        ...
        if self.arg.phase == 'train':
            ...
            #                      "train", 6667, self.arg.work_dir1, self.recoder, self.arg.evaluate_tool)
            dev_wer = seq_eval(self.arg, self.data_loader["dev"], self.model, self.device,
